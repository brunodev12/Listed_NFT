...
def buyToken(token_id, _nonce):
    ...
    if len(data['orders'])>0:
        ...
        if (considerationToken==nullAddress and price<9) or (considerationToken!=nullAddress and price <0.005):
            ...
            if address_balance/(10**18) < price:
                ...
                if (gas_price_matic * 500000)>1:
                    ...
                    send_email(f"https://polygonscan.com/tx/{w3.to_hex(tx_hash)}", "Transaction sent")
